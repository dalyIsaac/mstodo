...
func Test_parserWrapper_parseDate(t *testing.T) {
	...
	tests := []struct {
		...
		{args: args{input: "02/January/2021 at 20:13", parseType: dateTimeParseType}, fields: testFields, want: wantDatetime, wantErr: false},
		{args: args{input: "02/January/2021, at 20:13", parseType: dateTimeParseType}, fields: testFields, want: wantDatetime, wantErr: false},
		{args: args{input: "02-January-2021 20:13", parseType: dateTimeParseType}, fields: testFields, want: wantDatetime, wantErr: false},
		{args: args{input: "02-January-2021, 20:13", parseType: dateTimeParseType}, fields: testFields, want: wantDatetime, wantErr: false},
		{args: args{input: "20:13 02-January-21", parseType: dateTimeParseType}, fields: testFields, want: wantDatetime, wantErr: false},
		{args: args{input: "20:13, 02-January-21", parseType: dateTimeParseType}, fields: testFields, want: wantDatetime, wantErr: false},
		{args: args{input: "2/January/2021 at 08:13 PM", parseType: dateTimeParseType}, fields: testFields, want: wantDatetime, wantErr: false},
		{args: args{input: "2/January/2021 at 08:13 pm", parseType: dateTimeParseType}, fields: testFields, want: wantDatetime, wantErr: false},
		{args: args{input: "02/01/2021 at 08:13PM", parseType: dateTimeParseType}, fields: testFields, want: wantDatetime, wantErr: false},
		{args: args{input: "2/01/2021 at 08:13pm", parseType: dateTimeParseType}, fields: testFields, want: wantDatetime, wantErr: false},
		{args: args{input: "2/01, 08:13pm", parseType: dateTimeParseType}, fields: testFields, want: wantDatetime, wantErr: false},
		{args: args{input: "8:13PM, 02-January 2021", parseType: dateTimeParseType}, fields: testFields, want: wantDatetime, wantErr: false},
		{args: args{input: "8:13pm, 02-January", parseType: dateTimeParseType}, fields: testFields, want: wantDatetime, wantErr: false},
		{args: args{input: "08:13PM on January 02, 2021", parseType: dateTimeParseType}, fields: testFields, want: wantDatetime, wantErr: false},
		{args: args{input: "08:13 pm, on January 02", parseType: dateTimeParseType}, fields: testFields, want: wantDatetime, wantErr: false},
		{args: args{input: "January 2 8:13PM", parseType: dateTimeParseType}, fields: testFields, want: wantDatetime, wantErr: false},
